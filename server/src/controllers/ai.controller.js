...
exports.generateCode = async (req, res, next) => {
  try {
    ...
    if (req.body.documentId) {
      ...
      boardConfig = {
        boardWidth: docData.board?.width ?? docData.boardSettings?.boardWidth ?? docData.boardWidth,
        boardHeight: docData.board?.height ?? docData.boardSettings?.boardHeight ?? docData.boardHeight,
        backgroundColor: docData.board?.background ?? docData.boardSettings?.backgroundColor ?? docData.backgroundColor,
      };
    } else {
