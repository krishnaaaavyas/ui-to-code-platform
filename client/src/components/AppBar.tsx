...
export default function AppBar() {
  ...
  const renderSaveStatus = () => {
    switch (saveStatus) {
      case "saving":
        return <span className="app-bar__status text-zinc-400">Saving...</span>;
      case "saved":
        return <span className="app-bar__status text-emerald-400">Saved</span>;
      case "error":
        return <span className="app-bar__status text-rose-400">Save Error</span>;
      case "conflict":
        return <span className="app-bar__status text-amber-400">Conflict</span>;
      default:
        return null;
    }
